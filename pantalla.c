...
*/
    ...
    if(get_disparar(nave) && cantidad_balas<MAX_BAL_PROP){
        ...
        centrado[1]=pos_nave[1]*escala-origen[1]+((VENTANA_ALTO/2.0));
 ...
 //dibujar_figura(renderer,figuras[2],"DISPARO",origen,escala);
