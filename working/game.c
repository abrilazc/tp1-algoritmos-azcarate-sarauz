...
void calcular_escala(figura_t **figuras, planeta_nombre planeta_actual,float *escala, float *centro, float planeta_min[2], float planeta_max[2]){
    ...
    *centro = (planeta_ancho + planeta_min[0]) / 2;
