...
void pantalla_nivel(nave_t *nave, figura_t ***figuras,nivel_t **niveles, SDL_Renderer *renderer, bool *goto_inicio, planeta_nombre *planeta_actual, float *f, float *centro, bool *reinicio);
//estado nave
...
bool interseccion_nave_polilinea(nave_t *nave,figura_t **figura,planeta_nombre nombre, float escala, float origen[2]);
